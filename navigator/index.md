...
- [ ] 수치해석 중단 ⏹  
- [x] 문일철 교수님 기초 ML  
- [ ] Convex Optimization (4/24) ![progress](http://progressed.io/bar/28 "progress")  
- [ ] Kmooc - 서울대 머신러닝 데이터마이닝  
- [x] Kmooc - 이지형 교수님 강의 완강  
- [x] STAT110 완강  
- [ ] [Bayesian Method for ML](https://www.coursera.org/learn/bayesian-methods-in-machine-learning?recoOrder=21&utm_medium=email&utm_source=recommendations&utm_campaign=4sMc0Hs9Eem5a3PcVrpGrg) (7/11) ![progress](http://progressed.io/bar/28 "progress")  
