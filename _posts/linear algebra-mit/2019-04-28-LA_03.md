...
# 3. Solving Ax=0
### 1) The Special Solution of Ax=0
...
# 4. Solving Ax=b
### 1) Solvability Condition of Ax=b
...
### 2) The Complete Solution of Ax=b
해를 구하는 알고리즘은 다음과 같다.
...
$$x_{nullspace}=c_1x_{special1}+c_2{special2}+\cdots$$  
...
# 5. Linear Independence, Span, Basis, Dimension
...
# 6. Dimensions of the Four Fundamental Subspaces
