...
u의 변화량을 알고 싶다.  
$$\Delta u=\frac{\partial u}{\partial x}\Delta x + \frac{\partial u}{\partial y}\Delta y+O(\epsilon2 ')$$  
...
$$\therefore \frac{\partial M}{\partial y}=\frac{\partial N}{\parital x} \rightarrow M=\frac{\partial u}{\partial x},N=\frac{\partial u}{\partial y}$$  

$$\text{if }\frac{\partial M}{\partial y}=\frac{\partial N}{\partial x} \rightarrow$$ 완전하다!(완전미분방정식)
$$Mdx+Ndy=0 \right u(x,y)=c$$  
...
실제로 살펴보면 x가 정해지면 C에의해서 y가 묶이게 된다.  
